import colectii_generics.Desc;
import colectii_generics.MyMap;
import colectii_generics.Student;
...
public class Main {
    ...
    private static void test3(){
        // sortare cu Comparator si Comparable
